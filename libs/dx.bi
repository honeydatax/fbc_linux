...
extern "C"
		...
		declare sub Ipixel  alias "Ipixel"(x as integer,y as integer,img as any ptr,r as byte,g as byte,b as byte)
		declare function creatImage  alias "creatImage"(w as integer,h as integer) as any ptr
		declare sub ccircle  alias "circle"(xx as integer,yy as integer,rr as integer,rcc as byte,gcc as byte,bcc as byte)
